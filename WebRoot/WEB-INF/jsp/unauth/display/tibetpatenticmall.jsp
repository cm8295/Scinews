                    ...
                    <td height="48" colspan="6">
                      ...
                      <form name="jumpSubject" action="SubjectDisplay" method="POST" onsubmit="return ifDigital1();"> 
                        ...
                        <tr>
                          ...
                          <A href="TibetPatentIcmAll?currentpage=0&content=<%=content%>&pagenumber=1&pagetype=jump&content=<%=content%>&pagetype=init%>" class="lan"><spring:message code="Display.FirstPage"/></A> 
                          <A href="TibetPatentIcmAll?currentpage=<%=currentpage%>&content=<%=content%>&pagenumber=1&pagetype=jump"  class="fy">1</A> 
                          <A href="TibetPatentIcmAll?currentpage=<%=currentpage%>&content=<%=content%>&pagenumber=2&pagetype=jump" class="fy">2</A> 
                          <A href="TibetPatentIcmAll?currentpage=<%=currentpage%>&content=<%=content%>&pagenumber=3&pagetype=jump" class="fy">3</A> 
                          <A href="TibetPatentIcmAll?currentpage=<%=currentpage%>&content=<%=content%>&pagenumber=4&pagetype=jump" class="fy">4</A> 
                          <A href="TibetPatentIcmAll?currentpage=<%=currentpage%>&content=<%=content%>&pagenumber=5&pagetype=jump" class="fy">5</A> 
                          <A href="TibetPatentIcmAll?currentpage=<%=currentpage%>&content=<%=content%>&pagetype=next" class="lan"><spring:message code="Display.NextPage"/></A> 
                          <A href="TibetPatentIcmAll?currentpage=<%=currentpage%>&content=<%=content%>&pagetype=previous" class="lan"><spring:message code="Display.PreviousPage"/></A> 
                          <A href="TibetPatentIcmAll?currentpage=<%=currentpage%>&content=<%=content%>&pagetype=last&totalcount=<%=totalcount%>" class="lan"><spring:message code="Display.LastPage"/></A>                           
