          ...
          <table width="996" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <table width="905" border="0" cellspacing="0" cellpadding="0">
                  <tr align="left">
                    <td width="905" height="48" colspan="6">
                      <table width="50%"  border="0" cellspacing="0" cellpadding="0">
                        <tr>
                         <td width="5" bgcolor="#BF4D00"></td>
                         <td width="300" align="center" valign="middle"><span class="bt"><strong class="bt"><font color="red"><%=content%></font>&nbsp;拥有专利浏览</strong></span></td>
                        </tr>
                      </table></td>
                    </tr>
                  <tr align="left">
                    ...
                    <td height="48" colspan="6">
                      ...
                      <form name="jumpSubject" action="SubjectDisplay" method="POST" onsubmit="return ifDigital1();"> 
                        ...
                        <tr>
                          ...
                          <A href="TibetPatentFpaAll?currentpage=0&content=<%=content%>&pagenumber=1&pagetype=jump&content=<%=content%>&pagetype=init%>" class="lan"><spring:message code="Display.FirstPage"/></A> 
                          <A href="TibetPatentFpaAll?currentpage=<%=currentpage%>&content=<%=content%>&pagenumber=1&pagetype=jump"  class="fy">1</A> 
                          <A href="TibetPatentFpaAll?currentpage=<%=currentpage%>&content=<%=content%>&pagenumber=2&pagetype=jump" class="fy">2</A> 
                          <A href="TibetPatentFpaAll?currentpage=<%=currentpage%>&content=<%=content%>&pagenumber=3&pagetype=jump" class="fy">3</A> 
                          <A href="TibetPatentFpaAll?currentpage=<%=currentpage%>&content=<%=content%>&pagenumber=4&pagetype=jump" class="fy">4</A> 
                          <A href="TibetPatentFpaAll?currentpage=<%=currentpage%>&content=<%=content%>&pagenumber=5&pagetype=jump" class="fy">5</A> 
                          <A href="TibetPatentFpaAll?currentpage=<%=currentpage%>&content=<%=content%>&pagetype=next" class="lan"><spring:message code="Display.NextPage"/></A> 
                          <A href="TibetPatentFpaAll?currentpage=<%=currentpage%>&content=<%=content%>&pagetype=previous" class="lan"><spring:message code="Display.PreviousPage"/></A> 
                          <A href="TibetPatentFpaAll?currentpage=<%=currentpage%>&content=<%=content%>&pagetype=last&totalcount=<%=totalcount%>" class="lan"><spring:message code="Display.LastPage"/></A>                           
