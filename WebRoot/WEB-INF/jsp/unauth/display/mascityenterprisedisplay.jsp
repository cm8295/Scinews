    ...
    <body>
        ...
        <div class="section">
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <span class="lv"><%=city%>:技术型企业信息</span>
                      <%
                         int i=0;
                         if(enterprises!=null)
                         {
                      ...
                      %>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-right">
                                <ul class="pagination">
                                    <li>
                                        <A href="masenterprisedisplay?currentpage=0&pagetype=init" class="lan"><spring:message code="Display.FirstPage"/></A>
                                    </li>
                                    <li>
                                        <A href="mascityenterprisedisplay?currentpage=<%=currentpage%>&city=<%=city%>&pagetype=previous" class="lan"><spring:message code="Display.PreviousPage"/></A>
                                    </li>
                                    <li>
                                        <A href="mascityenterprisedisplay?currentpage=<%=currentpage%>&city=<%=city%>&pagenumber=1&pagetype=jump" class="fy">1</A>
                                    </li>
                                    <li>
                                        <A href="mascityenterprisedisplay?currentpage=<%=currentpage%>&city=<%=city%>&pagenumber=2&pagetype=jump" class="fy">2</A>
                                    </li>
                                    <li>
                                        <A href="mascityenterprisedisplay?currentpage=<%=currentpage%>&city=<%=city%>&pagenumber=3&pagetype=jump" class="fy">3</A>
                                    </li>
                                    <li>
                                        <A href="mascityenterprisedisplay?currentpage=<%=currentpage%>&city=<%=city%>&pagenumber=4&pagetype=jump" class="fy">4</A>
                                    </li>
                                    <li>
                                        <A href="mascityenterprisedisplay?currentpage=<%=currentpage%>&city=<%=city%>&pagenumber=5&pagetype=jump" class="fy">5</A>
                                    </li>
                                    <li>
                                        <A href="mascityenterprisedisplay?currentpage=<%=currentpage%>&city=<%=city%>&pagetype=next" class="lan"><spring:message code="Display.NextPage"/></A> 
                                    </li>
                                    <li>
                                        <A href="mascityenterprisedisplay?currentpage=<%=currentpage%>&city=<%=city%>&pagetype=last&totalcount=<%=totalcount%>" class="lan"><spring:message code="Display.LastPage"/></A> 
                                    </li>
                    ...
                    <div class="col-md-3">
                      ...
                      <div class="thumbnail">
                            <div class="caption">
                                 ...
                                 <span class="lv">技术型企业</span>
                                <ul>
                                  <li class="lanmu">四川红光汽车机电有限公司</li>
                                  <li class="lanmu">成都旭光电子股份有限公司</li>
                                  <li class="lanmu">成都航天模塑股份有限公司</li>
                                  <li class="lanmu">四川川开实业发展有限公司</li>
                                  <li class="lanmu">四川水井坊股份有限公司</li>
                                  <li class="lanmu">四川宁江精密工业有限责任公司</li>
                                  <li class="lanmu">中国航天科技集团公司烽火机械厂</li>
                                  <li class="lanmu">安蓉建设总公司  </li>
                                </ul>
                                <ul>
                                  <ui></ui>
                                </ul>
                        ...
                        <div class="thumbnail">
                            <div class="caption">
                              <span class="lv">技术型企业</span>
                                <ul>
                                    <li class="lanmu">四川申蓉汽车股份有限公司</li>
                                    <li class="lanmu">成都虹波实业股份有限公司</li>
                                    <li class="lanmu">成都华日通讯技术有限公司</li>
                                    <li class="lanmu">四川公路桥梁建设集团有限公司</li>
                                    <li class="lanmu">中国华西企业有限公司</li>
                                    <li class="lanmu">四川电器集团股份有限公司</li>
                                    <li class="lanmu">成都硅宝科技股份有限公司</li>
                                    <li class="lanmu">成都国腾电子技术股份有限公司</li>
                                    <ui></ui>
                                </ul>
                            </div>
                        </div>
