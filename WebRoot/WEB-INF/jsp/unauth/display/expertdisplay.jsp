...
String[] exprovfacet = (String[])request.getAttribute("provfacet");
Integer[] exprovfacetcount = (Integer[])request.getAttribute("provfacetcount");
              ...
              <tr>
                <td width="216" height="782" align="center" valign="top" bgcolor="#dfe6ec"><table width="216" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="176" align="left" bgcolor="#627289" class="bai">所属省市</td>
                  ...
                  <tr>
                    <td height="84" colspan="3" align="center" valign="middle">
					  ...
					  <table width="200" border="0" align="center" cellpadding="0" cellspacing="0">
					    ...
					    %>
                                 <tr>
                                   <td width="60" height="27" align="left" class="hei3"><a href="ExpertFacetDisplay?&currentpage=0&pagenumber=1&pagetype=jump&term=<%=term%>&facet=expertprov&content=<%=exprovfacet[n]%>"  class="hei3"><%=exprovfacet[n]%></a></td>
                                   <td width="48" height="27" align="left" class="hei3">[<%=exprovfacetcount[n]%>]</td>
                                   <%
                                        n++;
                                   %>
                                   <td width="45" height="27" align="left" class="hei3"><a href="ExpertFacetDisplay?&currentpage=0&pagenumber=1&pagetype=jump&term=<%=term%>&facet=year&content=<%=exprovfacet[n]%>"  class="hei3"><%=exprovfacet[n]%></a></td>
					     ...
					     %>
                                 ...
                                 <%
	                              ...
	                              {                                 
                                 %>
                                   <td width="45" height="27" align="left" class="hei3"><a href="ExpertFacetDisplay?&currentpage=0&pagenumber=1&pagetype=jump&term=<%=term%>&facet=expertprov&content=<%=exprovfacet[n]%>" class="hei3"><%=exprovfacet[n]%></a></td>
                                   <td width="34" height="27" align="left" class="hei3">[<%=exprovfacetcount[n]%>]</td>
                                 </tr>					          	  
					     <%   	  
	                              }
                  ...
                  <tr>
                    ...
                    <td height="35" align="left" bgcolor="#627289" class="bai">学科领域</td>
                  ...
                  <tr valign="top">
					...
					<table width="200" border="0" align="center" cellpadding="0" cellspacing="0">
					  ...
					  %>
					  <tr>
                        <td width="155" height="22" align="left" class="hei3"><a href="ExpertFacetDisplay?&currentpage=0&pagenumber=1&pagetype=jump&term=<%=term%>&facet=expertxk&content=<%=xkfacet[i]%>" class="hei3"><%=xkfacet[i]%></a></td>
                  ...
                  <tr>
                    <td height="35" bgcolor="#627289">&nbsp;</td>
                    <td height="35" align="left" bgcolor="#627289" class="bai">所属机构</td>
                    <td height="35" bgcolor="#627289"><span class="bai"><img src="images/more.jpg" width="11" height="11" align="middle"></span></td>
                  </tr>
                  <tr valign="top">
					...
					<table width="200" border="0" align="center" cellpadding="0" cellspacing="0">
					  ...
					  %>
                      <tr>
                        <td width="170" height="22" align="left" class="hei3"><a href="ExpertFacetDisplay?&currentpage=0&pagenumber=1&pagetype=jump&term=<%=term%>&facet=expertwork&content=<%=workfacet[i]%>" class="hei3"><%=workfacet[i]%></a></td>
                    ...
                    <tr align="left">
                      <td height="48" colspan="6"><table width="16%"  border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="120" align="center" valign="middle"><span class="bt"><strong class="bt">专家信息浏览</strong></span></td>
                        </tr>
                      </table></td>
                    </tr>
                    <tr align="left">
					 ...
					 <form name="jumpSubject" action="SubjectDisplay" method="POST" onsubmit="return ifDigital1();"> 
					  <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          ...
                          <A href="Expertdisplay?currentpage=0&pagetype=init%>" class="lan"><spring:message code="Display.FirstPage"/></A> 
                          <A href="Expertdisplay?currentpage=<%=currentpage%>&pagenumber=1&pagetype=jump"  class="fy">1</A> 
                          <A href="Expertdisplay?currentpage=<%=currentpage%>&pagenumber=2&pagetype=jump" class="fy">2</A> 
                          <A href="Expertdisplay?currentpage=<%=currentpage%>&pagenumber=3&pagetype=jump" class="fy">3</A> 
                          <A href="Expertdisplay?currentpage=<%=currentpage%>&pagenumber=4&pagetype=jump" class="fy">4</A> 
                          <A href="Expertdisplay?currentpage=<%=currentpage%>&pagenumber=5&pagetype=jump" class="fy">5</A> 
                          <A href="Expertdisplay?currentpage=<%=currentpage%>&pagetype=next" class="lan"><spring:message code="Display.NextPage"/></A> 
                          <A href="Expertdisplay?currentpage=<%=currentpage%>&pagetype=previous" class="lan"><spring:message code="Display.PreviousPage"/></A> 
                          <A href="Expertdisplay?currentpage=<%=currentpage%>&pagetype=last&totalcount=<%=totalcount%>" class="lan"><spring:message code="Display.LastPage"/></A>                           
