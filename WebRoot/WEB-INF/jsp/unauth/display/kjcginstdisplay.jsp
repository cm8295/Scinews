                  ...
                  <tr align="left">
                    <td width="905" height="48" colspan="6"><table width="16%"  border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="120" align="center" valign="middle"><span class="bt"><strong class="bt">成果所属机构</strong></span></td>
                        </tr>
                      </table></td>
                    </tr>
                  <tr align="left">
                    ...
                    <td height="48" colspan="6">
                      ...
                      <form name="jumpSubject" action="SubjectDisplay" method="POST" onsubmit="return ifDigital1();"> 
                        ...
                        <tr>
                          ...
                          <A href="KjcgInstdisplay?currentpage=0&pagetype=init&inst=<%=inst%>" class="lan"><spring:message code="Display.FirstPage"/></A> 
                          <A href="KjcgInstdisplay?inst=<%=inst%>&currentpage=<%=currentpage%>&pagenumber=1&pagetype=jump"  class="fy">1</A> 
                          <A href="KjcgInstdisplay?inst=<%=inst%>&currentpage=<%=currentpage%>&pagenumber=2&pagetype=jump" class="fy">2</A> 
                          <A href="KjcgInstdisplay?inst=<%=inst%>&currentpage=<%=currentpage%>&pagenumber=3&pagetype=jump" class="fy">3</A> 
                          <A href="KjcgInstdisplay?inst=<%=inst%>&currentpage=<%=currentpage%>&pagenumber=4&pagetype=jump" class="fy">4</A> 
                          <A href="KjcgInstdisplay?inst=<%=inst%>&currentpage=<%=currentpage%>&pagenumber=5&pagetype=jump" class="fy">5</A> 
                          <A href="KjcgInstdisplay?inst=<%=inst%>&currentpage=<%=currentpage%>&pagetype=next" class="lan"><spring:message code="Display.NextPage"/></A> 
                          <A href="KjcgInstdisplay?inst=<%=inst%>&currentpage=<%=currentpage%>&pagetype=previous" class="lan"><spring:message code="Display.PreviousPage"/></A> 
                          <A href="KjcgInstdisplay?inst=<%=inst%>&currentpage=<%=currentpage%>&pagetype=last&totalcount=<%=totalcount%>" class="lan"><spring:message code="Display.LastPage"/></A>                           
                   ...
                   %>   
                    ...
                    <tr>
                      <td width="897" class="bb"><table width="900" border="0" cellspacing="0" cellpadding="0">
                           <tr bgcolor="#E8F9FD">
                            <td width="37" height="30" align="center" valign="middle" ><img src="images/374.gif" width="16" height="16" class="lan"></td>                            
                            <td height="30" colspan="4" align="left" valign="middle" class="big"><div align="left"> <span class="hei2"><a href="kjcgdetail?kjcgid=<%=kjcg.getId()%>" target="_blank" title="<%=kjcg.getId()%>" class="hong2"><%=kjcg.getITEM_3()%></a></span></div></td>
                          </tr>
                          <tr>
                            <td width="37" height="30" align="center" valign="middle" ></td>
                            <td width="67" height="30" align="left" valign="middle" class="lan"><spring:message code="Home.Conference.Date"/>:</td>
                          ...
                          <tr>
                            <td width="37" height="30" align="center" valign="middle" ></td>
                            <td width="67" height="30" align="left" valign="middle" class="lan"><spring:message code="Detail.Conference.Location"/>:</td>
