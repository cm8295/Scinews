                ...
                <table width="905" border="0" cellspacing="0" cellpadding="0">
                  <tr align="left">
                    <td width="905" height="48" colspan="6"><table width="16%"  border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="120" align="center" valign="middle"><span class="bt"><strong class="bt">专家所属机构</strong></span></td>
                        </tr>
                      </table></td>
                    </tr>
                  <tr align="left">
                  ...
                  <tr align="left">
                   ...
                   <%
                      ...
                      if(workfacet!=null)
                      {
                        for(int m=0; m<workfacet.length; m++)
                        {         
	                       int i = m + 1 ;
                   %>   
                      ...
                      <td width="897" class="bb">
                        <table width="900" border="0" cellspacing="0" cellpadding="0">
                          <tr bgcolor="#E8F9FD">
                            ...
                            <td height="30"  colspan="4" align="left" valign="middle" class="big"><a href="ExpertInstdisplay?inst=<%=workfacet[m]%>&currentpage=0&pagetype=init" target="_blank" class="hei3" title="<%=workfacet[m]%>"><%=workfacet[m]%></a>&nbsp;<span class="red3">(<%=workfacetcount[m]%>)</span></td>
                           <%
                              if(i<workfacet.length)
                              {
                           %>
                            <td width="20" height="30" align="left" valign="middle" ><img src="images/374.gif" width="16" height="16" class="lan"></td> 
                            <td height="30"  colspan="4" align="left" valign="middle" class="big"><a href="ExpertInstdisplay?inst=<%=workfacet[i]%>&currentpage=0&pagetype=init" target="_blank" class="hei3" title="<%=workfacet[i]%>"><%=workfacet[i]%></a>&nbsp;<span class="red3">(<%=workfacetcount[i]%>)</span></td>
                           <%
                              }
                              if((i+1)<workfacet.length)
                              {
                           %> 
                            <td width="20" height="30" align="left" valign="middle" ><img src="images/374.gif" width="16" height="16" class="lan"></td> 
                            <td height="30"  colspan="4" align="left" valign="middle" class="big"><a href="ExpertInstdisplay?inst=<%=workfacet[i]%>&currentpage=0&pagetype=init" target="_blank" class="hei3" title="<%=workfacet[i+1]%>"><%=workfacet[i+1]%></a>&nbsp;<span class="red3">(<%=workfacetcount[i+1]%>)</span></td>                           
                           <%
                              }
                           %>
                          </tr>
