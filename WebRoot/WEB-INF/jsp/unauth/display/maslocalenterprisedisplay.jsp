                      ...
                      %>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-right">
                                <ul class="pagination">
                                    <li>
                                        <A href="mastypeenterprisedisplay?local=<%=local%>&currentpage=0&pagetype=init" class="lan"><spring:message code="Display.FirstPage"/></A>
                                    </li>
                                    <li>
                                        <A href="mastypeenterprisedisplay?local=<%=local%>&currentpage=<%=currentpage%>&pagetype=previous" class="lan"><spring:message code="Display.PreviousPage"/></A>
                                    </li>
                                    <li>
                                        <A href="mastypeenterprisedisplay?local=<%=local%>&currentpage=<%=currentpage%>&pagenumber=1&pagetype=jump" class="fy">1</A>
                                    </li>
                                    <li>
                                        <A href="mastypeenterprisedisplay?local=<%=local%>&currentpage=<%=currentpage%>&pagenumber=2&pagetype=jump" class="fy">2</A>
                                    </li>
                                    <li>
                                        <A href="mastypeenterprisedisplay?local=<%=local%>&currentpage=<%=currentpage%>&pagenumber=3&pagetype=jump" class="fy">3</A>
                                    </li>
                                    <li>
                                        <A href="mastypeenterprisedisplay?local=<%=local%>&currentpage=<%=currentpage%>&pagenumber=4&pagetype=jump" class="fy">4</A>
                                    </li>
                                    <li>
                                        <A href="mastypeenterprisedisplay?local=<%=local%>&currentpage=<%=currentpage%>&pagenumber=5&pagetype=jump" class="fy">5</A>
                                    </li>
                                    <li>
                                        <A href="mastypeenterprisedisplay?local=<%=local%>&currentpage=<%=currentpage%>&pagetype=next" class="lan"><spring:message code="Display.NextPage"/></A> 
                                    </li>
                                    <li>
                                        <A href="mastypeenterprisedisplay?local=<%=local%>&currentpage=<%=currentpage%>&pagetype=last&totalcount=<%=totalcount%>" class="lan"><spring:message code="Display.LastPage"/></A> 
                                    </li>
