                ...
                <td width="216" height="782" align="center" valign="top" bgcolor="#dfe6ec"><table width="216" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td height="84" colspan="3" align="center" valign="middle">
					  ...
					  <table width="200" border="0" align="center" cellpadding="0" cellspacing="0">
					    ...
					    %>
                                 <tr>
                                   <td width="60" height="27" align="left" class="hei3"><a href="PatentFacetDisplay?currentpage=0&pagenumber=1&pagetype=jump&facet=patentad&content=<%=adfacet[n]%>"  class="hei3"><%=adfacet[n]%></a>年</td>
                                   <td width="48" height="27" align="left" class="hei3">[<%=adfacetcount[n]%>]</td>
                                   <%
                                        n++;
                                   %>
                                   <td width="45" height="27" align="left" class="hei3"><a href="PatentFacetDisplay?currentpage=0&pagenumber=1&pagetype=jump&facet=patentad&content=<%=adfacet[n]%>"  class="hei3"><%=adfacet[n]%></a>年</td>
                  ...
                  <tr valign="top">
					...
					<table width="200" border="0" align="center" cellpadding="0" cellspacing="0">
					  ...
					  %>
					  <tr>
                        <td width="155" height="22" align="left" class="hei3"><a href="PatentFacetDisplay?currentpage=0&pagenumber=1&pagetype=jump&facet=patenticm&content=<%=icmfacet[i]%>" class="hei3"><%=icmfacet[i]%></a></td>
                  ...
                  <tr valign="top">
					...
					<table width="200" border="0" align="center" cellpadding="0" cellspacing="0">
					  ...
					  %>
                      <tr>
                        <td width="170" height="22" align="left" class="hei3"><a href="PatentFacetDisplay?currentpage=0&pagenumber=1&pagetype=jump&facet=patentinst&content=<%=fpafacet[i]%>" class="hei3"><%=fpafacet[i]%></a></td>
