...
String entclass = request.getAttribute("entclass").toString();
%>
    ...
    <body>
        ...
        <div class="section">
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <span class="lv"><font color="red"><%=entclass%></font>: 技术型企业信息浏览</span>    
                      <%
                         int i=0;
                         if(enterprises!=null)
                         {
                      ...
                      %>
                       ...
                       <div class="row">
                            <div class="col-md-12 text-right">
                                <ul class="pagination">
                                    <li>
                                        <A href="classenterprisedisplay?currentpage=0&entclass=<%=entclass%>&pagetype=init" class="lan"><spring:message code="Display.FirstPage"/></A>
                                    </li>
                                    <li>
                                        <A href="classenterprisedisplay?currentpage=<%=currentpage%>&entclass=<%=entclass%>&pagetype=previous" class="lan"><spring:message code="Display.PreviousPage"/></A>
                                    </li>
                                    <li>
                                        <A href="classenterprisedisplay?currentpage=<%=currentpage%>&entclass=<%=entclass%>&pagenumber=1&pagetype=jump" class="fy">1</A>
                                    </li>
                                    <li>
                                        <A href="classenterprisedisplay?currentpage=<%=currentpage%>&entclass=<%=entclass%>&pagenumber=2&pagetype=jump" class="fy">2</A>
                                    </li>
                                    <li>
                                        <A href="classenterprisedisplay?currentpage=<%=currentpage%>&entclass=<%=entclass%>&pagenumber=3&pagetype=jump" class="fy">3</A>
                                    </li>
                                    <li>
                                        <A href="classenterprisedisplay?currentpage=<%=currentpage%>&entclass=<%=entclass%>&pagenumber=4&pagetype=jump" class="fy">4</A>
                                    </li>
                                    <li>
                                        <A href="classenterprisedisplay?currentpage=<%=currentpage%>&entclass=<%=entclass%>&pagenumber=5&pagetype=jump" class="fy">5</A>
                                    </li>
                                    <li>
                                        <A href="classenterprisedisplay?currentpage=<%=currentpage%>&entclass=<%=entclass%>&pagetype=next" class="lan"><spring:message code="Display.NextPage"/></A> 
                                    </li>
                                    <li>
                                        <A href="classenterprisedisplay?currentpage=<%=currentpage%>&entclass=<%=entclass%>&pagetype=last&totalcount=<%=totalcount%>" class="lan"><spring:message code="Display.LastPage"/></A> 
                                    </li>
