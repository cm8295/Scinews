                  ...
                  <tr align="left">
                    <td width="905" height="48" colspan="6"><table width="16%"  border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="120" align="center" valign="middle"><span class="bt"><strong class="bt">专家所属省市</strong></span></td>
                        </tr>
                      </table></td>
                    </tr>
                  <tr align="left">
                      ...
                      <td width="897" class="bb">
                        <table width="900" border="0" cellspacing="0" cellpadding="0">
                          <tr bgcolor="#E8F9FD">
                            ...
                            <td height="30"  colspan="4" align="left" valign="middle" class="big"><a href="ExpertProvdisplay?prov=<%=provfacet[m]%>&currentpage=0&pagetype=init" target="_blank" class="hei3" title="<%=provfacet[m]%>"><%=provfacet[m]%></a>&nbsp;<span class="red3">(<%=provfacetcount[m]%>)</span></td>
                           <%
                              if(i<provfacet.length)
                              {
                           %>
                            <td width="20" height="30" align="left" valign="middle" ><img src="images/374.gif" width="16" height="16" class="lan"></td> 
                            <td height="30"  colspan="4" align="left" valign="middle" class="big"><a href="ExpertProvdisplay?prov=<%=provfacet[i]%>&currentpage=0&pagetype=init" target="_blank" class="hei3" title="<%=provfacet[i]%>"><%=provfacet[i]%></a>&nbsp;<span class="red3">(<%=provfacetcount[i]%>)</span></td>
                           <%
                              }
                              if((i+1)<provfacet.length)
                              {
                           %> 
                            <td width="20" height="30" align="left" valign="middle" ><img src="images/374.gif" width="16" height="16" class="lan"></td> 
                            <td height="30"  colspan="4" align="left" valign="middle" class="big"><a href="ExpertProvdisplay?prov=<%=provfacet[i]%>&currentpage=0&pagetype=init" target="_blank" class="hei3" title="<%=provfacet[i+1]%>"><%=provfacet[i+1]%></a>&nbsp;<span class="red3">(<%=provfacetcount[i+1]%>)</span></td>                           
                           <%
                              }
                           %>
                          </tr>
