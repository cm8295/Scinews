  ...
  <td>
   <table>
     ...
     <%
        ...
        {
     %>
         &nbsp;<%=realname%>(<%=institute%>),您已经为本平台推荐了<%=totalcount%>条信息。目前总积分为<%=totalcount * 5 %>。<a href="UserReConference?loginname=<%=loginname%>">点击查看</a>您推荐的信息及状态。</td>
     <%
        }
        else
        {
     %>
         <%=realname%>(<%=institute%>),欢迎您登录会议平台。希望您能够为我们推荐会议信息，谢谢！</td>
     <%
        }
     %>  
     </tr>
                   ...
                   <tr align="left" valign="middle" bgcolor="#FFFFFF">
                    <td height="57" colspan="2"><table width="50%"  border="0" align="left" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td width="300" align="center" valign="bottom"><span class="style3"><spring:message code="User.Recommand"/> | <a href="ReConferenceDisplay?currentpage=0&amp;pagetype=init&name=<%=loginname%>"><spring:message code="User.Search.Recommend"/></a></span></td>
                        </tr>
                  </table></td>
                  </tr>
                  <tr>
