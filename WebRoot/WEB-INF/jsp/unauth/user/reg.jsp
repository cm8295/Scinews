...
<%@ page import="gov.lct.model.Trole" %>
<%
...
<table width="1002"  border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
        	...
        	<table width="80%"  border="1" cellspacing="0" cellpadding="0">
        	  <tr>
        	    ...
        	    <td width="70%" height="50" align="left" valign="middle"><input type="text" id="loginname" name="loginname" size="40" maxlength="100" height="40"></input> <font color="red">*</font></td>
        	  </tr>  
        	  <tr>
        	  ...
        	  <tr>
        	    <td width="30%" height="50" align="center" valign="middle" class="bigblue">角色</td>
        	    <td width="70%" height="50" align="left" valign="middle">
	              ...
	              <%
	                 if(availableItems!=null)
	                 {
                       while(roles.hasNext())
                       {
                    	 Trole roleinfo = (Trole)roles.next();  
                  %>
                         <option value=<%=roleinfo.getRolecode()%>><%=roleinfo.getRolename()%></option>
                  <%
                       }
	                 }
                  %> 
  ...
  <tr>
    <td width="170" background="images/bj3.jpg"><div align="center">
    </div></td>
    <td width="217" align="right" background="images/bj3.jpg"><img src="images/dicp.jpg" width="188" height="103"></td>
    <td width="615" background="images/bj3.jpg"><%@ include file="/common/footer.jsp" %></td>
  </tr>
</table>
<br>
</body>
