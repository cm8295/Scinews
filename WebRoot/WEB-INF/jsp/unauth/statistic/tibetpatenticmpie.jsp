  ...
  <td align="center" id="svg">
   	<script type="text/javascript">		
        ...
        .on("click",function(d,i){
    	  ...
    	  var url = 'TibetPatentIcmDisplay?currentpage=0&pagenumber=1&pagetype=jump&content='+icm[i];
    	  GetPatentbyAjax(url);
			})			
		.text(function(d,i){
         ...
         <tr>
          ...
          <table width="996" border="0" cellpadding="0" cellspacing="0">
			 ...
			 <table width="720"  border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td height="40" align="right" class="lan">
                          <A href="TibetPatentIcmpie?currentpage=0&pagenumber=1&pagetype=jump&pagetype=init%>" class="lan"><spring:message code="Display.FirstPage"/></A> 
                          <A href="TibetPatentIcmpie?currentpage=<%=currentpage%>&pagenumber=1&pagetype=jump"  class="fy">1</A> 
                          <A href="TibetPatentIcmpie?currentpage=<%=currentpage%>&pagenumber=2&pagetype=jump" class="fy">2</A> 
                          <A href="TibetPatentIcmpie?currentpage=<%=currentpage%>&pagenumber=3&pagetype=jump" class="fy">3</A> 
                          <A href="TibetPatentIcmpie?currentpage=<%=currentpage%>&pagenumber=4&pagetype=jump" class="fy">4</A> 
                          <A href="TibetPatentIcmpie?currentpage=<%=currentpage%>&pagenumber=5&pagetype=jump" class="fy">5</A> 
                          <A href="TibetPatentIcmpie?currentpage=<%=currentpage%>&pagetype=next" class="lan"><spring:message code="Display.NextPage"/></A> 
                          <A href="TibetPatentIcmpie?currentpage=<%=currentpage%>&pagetype=previous" class="lan"><spring:message code="Display.PreviousPage"/></A> 
                          <A href="TibetPatentIcmpie?currentpage=<%=currentpage%>&pagetype=last&totalcount=<%=totalcount%>" class="lan"><spring:message code="Display.LastPage"/></A>                           
                              <spring:message code="Display.Jump"/> 
                            <input type="hidden" name="currentpage" value="<%=currentpage%>"/>
                            <input type="hidden" name="pagetype" value="jump"/>
                            <input type="text" name="pagenumber" id="pagenumber1" value="" size="3"/>
