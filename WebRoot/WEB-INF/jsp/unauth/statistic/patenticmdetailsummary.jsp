...
if(icmfacet!=null)
{
  if(icmfacet.length>15)
	count = 15;
  else
	count = icmfacet.length;	 
...
for (int i=0;i<count-1 ;i++ )
{
    ...
    for (int j=i+1;j<count ;j++ )
    {
      if(icmfacet[j]!=null)
      {
        if ((icmfacet[min].compareTo(icmfacet[j]))>0) //如果这里是>0，则为顺序排
        {
          min=j;
        }
      }
    ...
    if (min!=i)
    {
     if(icmfacet[i]!=null)
     {	
       String temp=icmfacet[i];
       icmfacet[i]=icmfacet[min];
       icmfacet[min]=temp;
     
       int temp1 = icmfacetcount[i];
       icmfacetcount[i] = icmfacetcount[min];
       icmfacetcount[min]=temp1;
     }
    }
  }
}
...
<table width="1002"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <%
    ...
    {   
      if(icmfacet[i]!=null)	
        data.addValue(icmfacetcount[i],"专利类别",icmfacet[i]+" 类"); 
    }
  %>	
  </div>
<br />
    ...
    <%
        ...
        numberaxis.setTickUnit(new NumberTickUnit(300));
...
<td>
     ...
     <%
        ...
        String[] month = new String[icmfacet.length];
        String[] monthcount = new String[icmfacet.length];
        for(int i=0;i<count;i++)
        {   
          if(icmfacet[i]!=null)	
        	linedataset.addValue(icmfacetcount[i],series,icmfacet[i]+"类"); // 对应的横轴 
        }
...
linerangeAxis.setTickUnit(new NumberTickUnit(300));
  ...
  %> 
	<tr>
	  <td height="30" align="center"><font size="3"><%=i+1%></font></td>    
 	  <td height="30" align="center"><a href="PatentIcmDeatilSummary?icm=<%=icmfacet[i]%>" class="hei"><font size="3"><%=icmfacet[i]%></font></a></td>
      <td height="30" align="center"><font size="3"><%=icmfacetcount[i]%></font></td>
	</tr>
