...
String[] fpa = new String[fpafacet.length];
Integer[] fpacount = new Integer[fpafacet.length];
...
if(fpafacet!=null)
{
  ...
  if(fpafacet.length>15)
	count = 15;
  else
	count = fpafacet.length;	
...
<table width="1002"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <%
    ...
    {   
      if(fpafacet[i]!=null)	
        data.addValue(fpafacetcount[i],"专利类别",fpafacet[i]+" 类"); 
    }
  %>	
  </div>
<br />
    ...
    <%
        ...
        numberaxis.setTickUnit(new NumberTickUnit(400));
...
<td>
     ...
     <%
        ...
        String[] month = new String[fpafacet.length];
        String[] monthcount = new String[fpafacet.length];
        for(int i=0;i<count;i++)
        {   
          if(fpafacet[i]!=null)	
        	linedataset.addValue(fpafacetcount[i],series,fpafacet[i]+"类"); // 对应的横轴 
        }
...
linerangeAxis.setTickUnit(new NumberTickUnit(400));
