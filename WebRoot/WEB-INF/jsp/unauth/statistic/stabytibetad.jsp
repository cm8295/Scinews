  ...
  <tr>
    <td>
     ...
     <!--插入页头完毕 -->   
       ...
       <tr> 
        <td >请选择年份跨度：
         <form method="GET" action="StatisticByTibetAd" >
...
<br />
    ...
    <%
        JFreeChart chart = ChartFactory.createBarChart3D("西藏自治区专利申请年统计图","年份","专利数量",data,PlotOrientation.VERTICAL,true,true,true);        
...
linerangeAxis.setTickUnit(new NumberTickUnit(50));
...
inter.setLabel("西藏自治区专利申请年统计折线图");    //设定区域说明文字
