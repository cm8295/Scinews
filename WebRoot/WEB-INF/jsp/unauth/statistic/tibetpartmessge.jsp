          ...
          <table width="996" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                            <td width="100%">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                               <tr>
                                <td height="33" align="left" valign="middle" class="lan"><spring:message code="Display.Totalcount"/><strong><font color="blue"><%=content%></font></strong>&nbsp;类专利<%=totalcount%><spring:message code="Display.Item"/></td>
                                <td height="33" align="left"  valign="middle" class="lan">&nbsp;&nbsp;<a href="TibetPatentIcmAll?currentpage=0&pagenumber=1&pagetype=jump&content=<%=content%>">点击浏览</a>所有记录</td>
                               </tr>
                              </table>
                            </td>
                        </tr>
			 ...
			 <table width="720"  border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <A href="PatentIcmDisplay?content=<%=content%>&currentpage=0&pagenumber=1&pagetype=jump&pagetype=init%>" class="lan"><spring:message code="Display.FirstPage"/></A> 
                          <A href="PatentIcmDisplay?content=<%=content%>&currentpage=<%=currentpage%>&pagenumber=1&pagetype=jump"  class="fy">1</A> 
                          <A href="PatentIcmDisplay?content=<%=content%>&currentpage=<%=currentpage%>&pagenumber=2&pagetype=jump" class="fy">2</A> 
                          <A href="PatentIcmDisplay?content=<%=content%>&currentpage=<%=currentpage%>&pagenumber=3&pagetype=jump" class="fy">3</A> 
                          <A href="PatentIcmDisplay?content=<%=content%>&currentpage=<%=currentpage%>&pagenumber=4&pagetype=jump" class="fy">4</A> 
                          <A href="PatentIcmDisplay?content=<%=content%>&currentpage=<%=currentpage%>&pagenumber=5&pagetype=jump" class="fy">5</A> 
                          <A href="PatentIcmDisplay?content=<%=content%>&currentpage=<%=currentpage%>&pagetype=next" class="lan"><spring:message code="Display.NextPage"/></A> 
                          <A href="PatentIcmDisplay?content=<%=content%>&currentpage=<%=currentpage%>&pagetype=previous" class="lan"><spring:message code="Display.PreviousPage"/></A> 
                          <A href="PatentIcmDisplay?content=<%=content%>&currentpage=<%=currentpage%>&pagetype=last&totalcount=<%=totalcount%>" class="lan"><spring:message code="Display.LastPage"/></A>                           
