...
<body>
 <form name="require" id="require" action="patentnorecommendsave" method="post">                    
   <table width="80%" height="50%" border=1 align="center" cellpadding=0 cellspacing=0 bgcolor="#FFFFFF">
     ...
     <tr>
       <td align="center">ID</td><td align="center">专利名称</td><td align="center">专利申请号</td><td align="center">专利权人</td><td align="center">取消推荐</td>
     </tr>
       <%
          int i=1;
       ...
       %>       
       <tr>
         <td><%=i%></td><td><%=patentinfo.getPatentTi()%></td><td><%=patentinfo.getPatentAn()%></td><td><%=patentinfo.getPatentFpa()%></td><td align="center"><input type="checkbox" name="patentcheck" value="<%=patentinfo.getId()%>"></td>
       </tr>
       <%
           i=i+1;
          }
