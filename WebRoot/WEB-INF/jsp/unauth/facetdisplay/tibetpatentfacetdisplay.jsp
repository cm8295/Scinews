                    ...
                    <td height="48" colspan="6">
                      ...
                      <form name="jumpSubject" action="SubjectDisplay" method="POST" onsubmit="return ifDigital1();"> 
                        ...
                        <tr>
                          ...
                          <A href="TibetPatentFacetDisplay?currentpage=0&facet=<%=facet%>&content=<%=content%>&pagenumber=1&pagetype=jump&facet=<%=facet%>&content=<%=content%>&pagetype=init%>" class="lan"><spring:message code="Display.FirstPage"/></A> 
                          <A href="TibetPatentFacetDisplay?currentpage=<%=currentpage%>&facet=<%=facet%>&content=<%=content%>&pagenumber=1&pagetype=jump"  class="fy">1</A> 
                          <A href="TibetPatentFacetDisplay?currentpage=<%=currentpage%>&facet=<%=facet%>&content=<%=content%>&pagenumber=2&pagetype=jump" class="fy">2</A> 
                          <A href="TibetPatentFacetDisplay?currentpage=<%=currentpage%>&facet=<%=facet%>&content=<%=content%>&pagenumber=3&pagetype=jump" class="fy">3</A> 
                          <A href="TibetPatentFacetDisplay?currentpage=<%=currentpage%>&facet=<%=facet%>&content=<%=content%>&pagenumber=4&pagetype=jump" class="fy">4</A> 
                          <A href="TibetPatentFacetDisplay?currentpage=<%=currentpage%>&facet=<%=facet%>&content=<%=content%>&pagenumber=5&pagetype=jump" class="fy">5</A> 
                          <A href="TibetPatentFacetDisplay?currentpage=<%=currentpage%>&facet=<%=facet%>&content=<%=content%>&pagetype=next" class="lan"><spring:message code="Display.NextPage"/></A> 
                          <A href="TibetPatentFacetDisplay?currentpage=<%=currentpage%>&facet=<%=facet%>&content=<%=content%>&pagetype=previous" class="lan"><spring:message code="Display.PreviousPage"/></A> 
                          <A href="TibetPatentFacetDisplay?currentpage=<%=currentpage%>&facet=<%=facet%>&content=<%=content%>&pagetype=last&totalcount=<%=totalcount%>" class="lan"><spring:message code="Display.LastPage"/></A>                           
